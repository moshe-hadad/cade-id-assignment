...
def full_process(isolated_data_set, interleaved_data_set):
    ...
    # util.save_data_set(data_set=isolated_df_processed, data_folder=data_folder, file_name='isolated_df_processed')
    ...
    interleaved_df_processed = features_eng.generate_features_from_sql(data_set=interleaved_data_set, columns=columns)
    # util.save_data_set(data_set=isolated_df_processed, data_folder=data_folder, file_name='interleaved_df_processed')
    ...
    #     file_path=os.path.join('../../processed_data/', 'isolated_df_processed.csv'))
...
if __name__ == '__main__':
    ...
    full_process(isolated_data_set, interleaved_data_set)
